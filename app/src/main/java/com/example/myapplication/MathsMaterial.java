...
public class MathsMaterial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(MathsMaterial.this);
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(MathsMaterial.this,MathsNotes.class);
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MathsMaterial.this,MathsVideo.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
...
//                        Toast.makeText(MathsMaterial.this, "No Application Available to View PDF",
...
//
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String URL = "https://drive.google.com/file/d/14saAQXyyLjPmNZ14OvXOqFuHtRBZCgwj/view?usp=sharing/M1_SAMPLE.pdf";
                File file = new File("/sdcard/example.pdf");
