...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(MainActivity5.this);
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(MainActivity5.this,JPRMaterial.class);
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity5.this,SENMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity5.this,DCCMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity5.this,MICMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
