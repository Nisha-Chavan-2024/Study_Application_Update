...
public class EngGraphicsMaterial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eng_graphics_material);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(EngGraphicsMaterial.this);
