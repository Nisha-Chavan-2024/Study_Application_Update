...
public class MainActivity6 extends AppCompatActivity {
    ...
    //    getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(MainActivity6.this);
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(MainActivity6.this,AJPMaterial.class);
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity6.this,ESTMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity6.this,OSYMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity6.this,STEMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity6.this,ACNMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
