...
public class BasicScienceMaterial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_science_material);
   ...
   //     getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(BasicScienceMaterial.this);
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(BasicScienceMaterial.this,BSCNotes.class);
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(BasicScienceMaterial.this,BSCVideo.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(BasicScienceMaterial.this,BSCManual.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(BasicScienceMaterial.this,BSCMcq.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
