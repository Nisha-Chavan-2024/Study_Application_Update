...
public class BSCManual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bscmanual);
      ...
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(BSCManual.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String URL = "https://drive.google.com/file/d/1MorFaH0fXL1NHu0fjWD2OCPH-hw9jZ84/view?usp=sharing/PHYSICS_MANUAL.pdf";
                ...
                if (file.exists()) {
                    ...
                    try {
                        ...
                        Toast.makeText(BSCManual.this, "No Application Available to View PDF",
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String URL = "https://drive.google.com/file/d/16r2FIJFoDrkN4l1MYAMVc2ikoi5D_Jid/view?usp=sharing/CHEMISTRY_MANUAL.pdf";
                File file = new File("/sdcard/example.pdf");
                if (file.exists()) {
                    Uri path = Uri.fromFile(file);
                    Intent intent = new Intent(Intent.ACTION_VIEW);
