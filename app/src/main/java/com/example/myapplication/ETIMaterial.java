...
public class ETIMaterial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etimaterial);
        ...
        dbManager.open();
        dbManager.fetch();
        dbHelper=new DatabaseHelper(ETIMaterial.this);
       ...
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        card3 = (CardView) findViewById(R.id.sample);


        card1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(ETIMaterial.this,ETINotes.class);
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(ETIMaterial.this,ETIVideo.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(ETIMaterial.this,ETIMcq.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
