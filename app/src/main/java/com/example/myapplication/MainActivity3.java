      ...
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(MainActivity3.this,CMaterial.class);
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity3.this,BasicElecMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity3.this,ApplMathsMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
        ...
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity3.this,ElementsMaterial.class);
                i.putExtra("Email",email);
                startActivity(i);
            }
        });
